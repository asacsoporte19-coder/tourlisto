...
export const getOSMSearch = async (query, location) => {
    ...
    try {
        ...
        return results.map(item => mapOSMToSuggestion(item, "Search Result"));
    } catch (e) {
...
const mapOSMToSuggestion = (item, defaultWhy) => {
...
const getCategoryQuery = (category, location) => {
    switch (category) {
...
export const getOSMCategorySuggestions = async (location, category) => {
...
export const getOSMSuggestions = async (location) => {
